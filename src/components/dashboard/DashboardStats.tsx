    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <h2 className="text-lg font-semibold mb-4">پیشرفت تکمیل سفارشات</h2>
          ...
          <div className="mt-6">
            <h3 className="text-sm font-medium text-gray-500 mb-3">وضعیت سفارشات</h3>
            <div className="space-y-2">
              {[
                { label: 'تکمیل شده', value: stats.fulfilled, color: 'bg-green-500' },
                { label: 'در انتظار', value: stats.pending, color: 'bg-yellow-500' },
                { label: 'خطا', value: stats.error, color: 'bg-red-500' },
              ].map((status) => (
